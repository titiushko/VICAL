DROP DATABASE IF EXISTS VICAL_BACKUP;
-- -------------------------------------------------------------------------------------
CREATE DATABASE VICAL_BACKUP DEFAULT CHARACTER SET latin1 COLLATE latin1_bin;
USE VICAL_BACKUP;

CREATE TABLE `centros_de_acopio` (
  `CODIGO_CENTRO_ACOPIO` char(6) NOT NULL,
  `NOMBRE_CENTRO_ACOPIO` varchar(50) NOT NULL,
...
INSERT INTO `centros_de_acopio` (`CODIGO_CENTRO_ACOPIO`, `NOMBRE_CENTRO_ACOPIO`, `CODIGO_RECOLECTOR`, `DIRECCION`, `DEPARTAMENTO`, `TELEFONO`) VALUES
('CA-001', 'ARAGON', 'R-002', 'CARRETERA A COMALAPA CONTIGUO A EMISION DE GASES ', 'San Salvador', '7165-8874');
...
CREATE TABLE `facturas` (
  ...
  KEY `FK_GUARDA` (`CODIGO_PROVEEDOR`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `facturas` (`CODIGO_FACTURA`, `CODIGO_PROVEEDOR`, `CODIGO_RECOLECTOR`, `SUCURSAL`, `FECHA`) VALUES
('2079', 118, 'R-001', 'VIGUA', '2011-08-26'),
('2082', 118, 'R-001', 'VIGUA', '2011-09-10'),
('2083', 118, 'R-001', 'VICESA', '2011-09-10'),
('2084', 119, 'R-002', 'VIGUA', '2011-09-10'),
('2085', 119, 'R-002', 'VICESA', '2011-09-10'),
('2087', 120, 'R-003', 'VIGUA', '2011-09-12'),
('2088', 120, 'R-003', 'VIGUA', '2011-09-12'),
('2090', 118, 'R-001', 'VIGUA', '2011-09-27'),
('2091', 118, 'R-001', 'VICESA', '2011-10-01'),
('2092', 120, 'R-003', 'VIGUA', '2011-09-27'),
('2093', 120, 'R-003', 'VIGUA', '2011-09-27'),
('2477', 61, 'R-001', 'VIGUA', '2011-09-10'),
('2478', 111, 'R-001', 'VIGUA', '2011-09-10'),
('2479', 111, 'R-001', 'VICESA', '2011-09-10'),
('2485', 118, 'R-001', 'VIGUA', '2011-09-27'),
('2487', 118, 'R-001', 'VIGUA', '2011-09-29'),
('2488', 118, 'R-001', 'VICESA', '2011-09-29'),
('2489', 120, 'R-003', 'VIGUA', '2011-09-29'),
('2491', 119, 'R-002', 'VIGUA', '2011-10-24'),
('2493', 118, 'R-001', 'VIGUA', '2011-10-27'),
('2494', 118, 'R-001', 'VIGUA', '2011-10-24'),
('2496', 111, 'R-001', 'VIGUA', '2011-10-24'),
('2498', 120, 'R-003', 'VIGUA', '2011-10-24'),
('2499', 120, 'R-001', 'VIGUA', '2011-10-24'),
('2500', 118, 'R-001', 'VIGUA', '2011-10-24'),
('2501', 120, 'R-003', 'VIGUA', '2011-10-24'),
('2502', 118, 'R-001', 'VIGUA', '2011-10-24'),
('2505', 118, 'R-001', 'VIGUA', '2011-10-24'),
('2506', 118, 'R-001', 'VIGUA', '2011-10-26'),
('2507', 118, 'R-001', 'VICESA', '2011-10-26'),
('2508', 120, 'R-003', 'VIGUA', '2011-10-26');

CREATE TABLE `precio` (
  `PRECIO_UNITARIO` float NOT NULL DEFAULT '1.2'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `precio` (`PRECIO_UNITARIO`) VALUES
(2);
...
(120, 'TE-11', 'RICARDO RAMOS', 'San Salvador', 'COL. MILAGRO 1 CALLE OTE NÂ° 41 SAN MARCOS', '7751-8690', '', 'RICARDO RAMOS', '');
...
('R-001', 'Jorge Hernandez', '7303-7148', '-', '---', ''),
('R-002', 'William Reyes', '7165-8874', '00343542-4', '0614-180184-108-7', 'Col. santisima trinidad'),
('R-003', 'RICARDO RAMOS', '7751-8690', '00343873-1', '0612-010250-001-2', 'COL. MILAGRO 1 CALLE OTE NÂ° 41 SAN MARCOS');
...
(1, 'Super Usuario', 'super', 'super', 1),
(2, 'William Reyes', 'william', '003435424', 1),
(3, 'Carlos Lopez', 'carlos', 'carlos', 2),
(4, 'Alfredo Fernande', 'alfredo', 'alfredo', 3);
...
INSERT INTO `vidrio` (`CODIGO_VIDRIO`, `CODIGO_TIPO`, `CODIGO_COLOR`, `CODIGO_FACTURA`, `CANTIDAD_VIDRIO`, `PRECIO`) VALUES
(3, 'TV-01', 'CV-02', '2079', 25.08, 50.16),
(4, 'TV-01', 'CV-02', '2082', 40.98, 81.96),
(5, 'TV-01', 'CV-01', '2083', 0.6, 1.2),
(6, 'TV-01', 'CV-03', '2083', 23.19, 46.38),
(7, 'TV-01', 'CV-01', '2085', 13.82, 27.64),
(8, 'TV-01', 'CV-03', '2085', 11.07, 22.14),
(9, 'TV-01', 'CV-02', '2084', 59.6, 119.2),
(10, 'TV-01', 'CV-01', '2479', 2.62, 5.24),
(11, 'TV-01', 'CV-03', '2479', 14.4, 28.8),
(12, 'TV-01', 'CV-02', '2478', 11.66, 23.32),
(13, 'TV-01', 'CV-02', '2477', 83.14, 166.28),
(14, 'TV-01', 'CV-02', '2087', 0.63, 1.26),
(15, 'TV-02', 'CV-02', '2088', 41.3, 37.17),
(16, 'TV-02', 'CV-02', '2485', 35, 31.5),
(17, 'TV-02', 'CV-02', '2092', 40.78, 36.7),
(18, 'TV-01', 'CV-02', '2090', 86.96, 173.92),
(19, 'TV-01', 'CV-02', '2093', 12.9, 25.8),
(20, 'TV-01', 'CV-01', '2488', 10.82, 21.64),
(21, 'TV-01', 'CV-03', '2488', 9.45, 18.9),
(22, 'TV-01', 'CV-02', '2487', 4.44, 8.88),
(23, 'TV-02', 'CV-02', '2489', 15.65, 14.09),
(24, 'TV-01', 'CV-01', '2091', 28.32, 56.64),
(25, 'TV-01', 'CV-03', '2091', 0, 0),
(28, 'TV-01', 'CV-02', '2491', 51.7, 103.4),
(29, 'TV-01', 'CV-02', '2496', 14.18, 28.36),
(30, 'TV-01', 'CV-02', '2498', 9.65, 19.3),
(31, 'TV-01', 'CV-02', '2502', 71, 142),
(32, 'TV-02', 'CV-02', '2501', 15, 13.5),
(33, 'TV-02', 'CV-02', '2499', 87, 78.3),
(34, 'TV-02', 'CV-02', '2494', 17, 15.3),
(35, 'TV-02', 'CV-02', '2505', 3, 2.7),
(36, 'TV-02', 'CV-02', '2500', 15, 13.5),
(37, 'TV-01', 'CV-02', '2091', 12.04, 24.08),
(38, 'TV-02', 'CV-02', '2506', 15, 13.5),
(39, 'TV-01', 'CV-01', '2507', 19, 38),
(40, 'TV-02', 'CV-02', '2508', 13, 11.7),
(41, 'TV-01', 'CV-02', '2493', 50, 100);


ALTER TABLE `centros_de_acopio`
  ADD CONSTRAINT `FK_ADMINISTRA` FOREIGN KEY (`CODIGO_RECOLECTOR`) REFERENCES `recolectores` (`CODIGO_RECOLECTOR`);

ALTER TABLE `compras`
  ADD CONSTRAINT `FK_REALIZA` FOREIGN KEY (`CODIGO_FACTURA`) REFERENCES `facturas` (`CODIGO_FACTURA`);

ALTER TABLE `facturas`
  ADD CONSTRAINT `FK_GUARDA` FOREIGN KEY (`CODIGO_PROVEEDOR`) REFERENCES `proveedores` (`CODIGO_PROVEEDOR`),
  ADD CONSTRAINT `FK_REGISTRA` FOREIGN KEY (`CODIGO_RECOLECTOR`) REFERENCES `recolectores` (`CODIGO_RECOLECTOR`);

ALTER TABLE `proveedores`
  ADD CONSTRAINT `FK_ESPECIFICA` FOREIGN KEY (`CODIGO_TIPO_EMPRESA`) REFERENCES `tipos_empresas` (`CODIGO_TIPO_EMPRESA`);

ALTER TABLE `vidrio`
  ADD CONSTRAINT `FK_DETALLA` FOREIGN KEY (`CODIGO_COLOR`) REFERENCES `colores_vidrio` (`CODIGO_COLOR`),
  ADD CONSTRAINT `FK_INCLUYE` FOREIGN KEY (`CODIGO_TIPO`) REFERENCES `tipos_vidrio` (`CODIGO_TIPO`),
  ADD CONSTRAINT `FK_POSEE` FOREIGN KEY (`CODIGO_FACTURA`) REFERENCES `facturas` (`CODIGO_FACTURA`);
