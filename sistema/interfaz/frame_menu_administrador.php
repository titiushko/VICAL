			...
			<ul>
				...
				<li class="nivel1" tabindex="3"><span class="nivel1">Proveedores</span>
					<ul>
						...
						<li><a href="<?php echo "../paginas/Proveedores/Estadisticas/frmEstadisticaProveedor.php?valor=estadisticas";?>" TARGET="CONTENIDO">Estadisticas de Proveedores</a></li>
					</ul>
				</li>
				<!--~~~~~~~~~~~~~~~~~~~~~~~~opcion3~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
				<li class="nivel1" tabindex="4"><span class="nivel1">Recolectores</span>
					<ul>
						...
						<li><a href="<?php echo "../paginas/Recolectores/Estadisticas/frmEstadisticaRecolector.php?valor=estadisticas";?>" TARGET="CONTENIDO">Estadisticas de Recolectores</a></li>
					</ul>
				</li>
				<!--~~~~~~~~~~~~~~~~~~~~~~~~opcion4~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
