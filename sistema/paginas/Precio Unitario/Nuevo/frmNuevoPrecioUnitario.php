...
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td colspan="2">
					...
					<center>
						<span class="obligatorio">* Datos requeridos</span><br><br>
						<div id="mensaje1" class="oculto"><span class="alerta error">&nbsp;&nbsp;El campo precio unitario no puede quedar vacio!!&nbsp;&nbsp;</span></div>
