				...
				<td align="center">
					...
					<table class="marco centro">
						...
						<tr>
							...
							<td>
								<input name="nombre_recolector" class="subtitulo1 fondo" size=39 <?php echo "value='".$recolectores["nombre_recolector"]."'";?> onKeyPress="return soloLetras(event)" onBlur="borrarMensaje(4);" onClick="borrarMensaje(4);">
							</td>
						</tr>
						<tr>
							<td align="right" class="titulo1">DUI:</td>
							<td>
								<input name="dui1" class="subtitulo1 fondo" type="text" value="<?php echo $dui1;?>" maxLength=8 size=7 onKeyup="autoTab(event.keyCode,this.name,7);" onKeyPress="return soloNumeros(event)" onBlur="borrarMensaje(4);" onClick="borrarMensaje(4);">
								<span class="subtitulo1">-</span>
								<input name="dui2" class="subtitulo1 fondo" type="text" value="<?php echo $dui2;?>" maxLength=1 size=1 onKeyup="autoTab(event.keyCode,this.name,2);" onKeyPress="return soloNumeros(event)" onBlur="borrarMensaje(4);" onClick="borrarMensaje(4);">
							</td>
						</tr>
						<tr>
							<td align="right" class="titulo1">NIT:</td>
							<td>
								<input name="nit1" class="subtitulo1 fondo" type="text" value="<?php echo $nit1;?>" maxLength=4 size=2 onKeyup="autoTab(event.keyCode,this.name,3);" onKeyPress="return soloNumeros(event)" onBlur="borrarMensaje(4);" onClick="borrarMensaje(4);">
								<span class="subtitulo1">-</span>
								<input name="nit2" class="subtitulo1 fondo" type="text" value="<?php echo $nit2;?>" maxLength=6 size=4 onKeyup="autoTab(event.keyCode,this.name,5);" onKeyPress="return soloNumeros(event)" onBlur="borrarMensaje(4);" onClick="borrarMensaje(4);">
								<span class="subtitulo1">-</span>
								<input name="nit3" class="subtitulo1 fondo" type="text" value="<?php echo $nit3;?>" maxLength=3 size=1 onKeyup="autoTab(event.keyCode,this.name,2);" onKeyPress="return soloNumeros(event)" onBlur="borrarMensaje(4);" onClick="borrarMensaje(4);">
								<span class="subtitulo1">-</span>
								<input name="nit4" class="subtitulo1 fondo" type="text" value="<?php echo $nit4;?>" maxLength=1 size=1 onKeyup="autoTab(event.keyCode,this.name,2);" onKeyPress="return soloNumeros(event)" onBlur="borrarMensaje(4);" onClick="borrarMensaje(4);">
							</td>
						</tr>
						<?php
						...
						<tr>
							...
							<td>
								<input name="telefono1" class="subtitulo1 fondo" type="text" value="<?php echo $telefono1;?>" maxLength=4 size=2 onKeyup="autoTab(event.keyCode,this.name,3);" onKeyPress="return soloNumeros(event)" onBlur="borrarMensaje(4);" onClick="borrarMensaje(4);">
								<span class="subtitulo1">-</span>
								<input name="telefono2" class="subtitulo1 fondo" type="text" value="<?php echo $telefono2;?>" maxLength=4 size=2 onKeyup="autoTab(event.keyCode,this.name,3);" onKeyPress="return soloNumeros(event)" onBlur="borrarMensaje(4);" onClick="borrarMensaje(4);">
							</td>
						</tr>
						<?php
						}
