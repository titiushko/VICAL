...
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td align="center">
					...
					<h1 class="encabezado1">AYUDA REGISTRO DE TIPOS DE EMPRESAS</h1>
					<h2 class="encabezado2">Como Registrar un Nuevo Tipo de Empresa</h2>
				</td>
			</tr>
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
						...
						<tr>
							<td align="center">
								<table>
									<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
									<tr>
										<td align="right" class="titulo1" style="vertical-align:text-top;">Nombre  de Empresa:</td>
										<td align="justify" class="subtitulo1">
											Digite el nombre del nuevo tipo de empresa a registrar en el sistema.<br>
											Este nombre es necesario.
											<hr>
										</td>
									</tr>
									<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
