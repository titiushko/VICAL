				...
				<td align="center">
					...
					<form name="formulario" action="RegistrarCompra.php" method="POST" onSubmit="return validarNuevaCompra(this,8);">
						...
						<tr>
							...
							<td align="left">						
								<input name="fecha" id="id1" class="requerido" type="text" size=7 readonly value="<?php echo date("Y-m-d");?>" onBlur="borrarMensaje(8), elementosVacios(7);" onClick="borrarMensaje(8), elementosVacios(7);">
								<img src="../../../imagenes/icono_calendario.png" onMouseOver="toolTip('Calendario',this)" onClick="displayCalendar(document.formulario.fecha,'yyyy-mm-dd',this),borrarMensaje(8), elementosVacios(7);" class="manita">
							...
							<td align="left">
								<input name="factura" id="id2" class="requerido" type="text" maxLength=4 size=1 onKeyPress="return soloNumeros(event)" onBlur="borrarMensaje(8), elementosVacios(7);" onClick="borrarMensaje(8), elementosVacios(7);">
								<span class="obligatorio">*</span>
							</td>
						</tr>
						<!--------------------------------RECOLECOR---------------------------------->
						<tr>
							...
							?>
								<select name="codigo_recolector" id="id3" class="requerido lista nombre" size="1" onBlur="borrarMensaje(8), elementosVacios(7);" onClick="borrarMensaje(8), elementosVacios(7);">
							...
							?>
								<input name="nombre_recolector" id="id3" class="requerido lista nombre" readonly value="<?php echo $nombre_recolector;?>" onBlur="borrarMensaje(8), elementosVacios(7);" onClick="borrarMensaje(8), elementosVacios(7);">
							<?php
							}
							?>
							</td>
						...
						<tr>
							...
							<td align="left">
								<select name="codigo_proveedor" id="id4" class="requerido lista nombre" size="1" onBlur="borrarMensaje(8), elementosVacios(7);" onClick="borrarMensaje(8), elementosVacios(7);">
						...
						<tr>
							...
							<td align="left">
								<select name="precio_compra" class="lista opcion" size="1" onBlur="borrarMensaje(8), elementosVacios(7);" onClick="borrarMensaje(8), elementosVacios(7);">
									<?php
							...
							<table id="id5" class="requerido" align="center" border bgcolor="white" width="60%">
								...
								<tbody>
									<tr>
										...
										<td><input name="Vc1" class="compra" type="text" size=3 onBlur="calcularMonto(),borrarMensaje(8), elementosVacios(7);" onKeyPress="return soloNumerosFloat(event)" onClick="borrarMensaje(8), elementosVacios(7);"></td>
						...
						<tr>
							...
							<td align="center" class="titulo1" colspan="4">
								Sucursal:
								<select name="sucursal" id="id6" class="requerido lista opcion" size="1" onBlur="borrarMensaje(8), elementosVacios(7);" onClick="borrarMensaje(8), elementosVacios(7);">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								Centro de Acopio:
								<select name="codigo_centro_acopio" id="id7" class="requerido lista" size="1" style="width: 160px;" onBlur="borrarMensaje(8), elementosVacios(7);" onClick="borrarMensaje(8), elementosVacios(7);">
									<option selected value="">.:Opciones:.</option>
									<?php
						...
						<tr>
							<td align="center" colspan="6">
								...
								<input name="Limpiar" type="reset" value="Limpiar" onMouseOver="toolTip('Limpiar',this)" class="boton limpiar" onClick="borrarMensaje(8), elementosVacios(7);">
