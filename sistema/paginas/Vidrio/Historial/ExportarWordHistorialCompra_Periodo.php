...
header("Content-Disposition: attachment; filename=HISTORIAL_DE_COMPRAS_DEL_".cambiarFecha(formatoFechaExtendida($fecha_inicial))."_AL_".cambiarFecha(formatoFechaExtendida($fecha_final)).".doc");
?>
<HTML>
	<head>
