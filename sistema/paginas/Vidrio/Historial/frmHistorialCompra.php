					...
					<td>
						<table align="center" class="marco">
							...
							<tr>
								...
								<div id="main">
									<!--------------------------------CRITERIOS---------------------------------->
									<ul id="criterios" class="subsection_tabs" onClick="borrarMensaje(4);">
									...
									<div style="display: none;" id="periodo">
										<form action="VerHistorialCompra_Periodo.php" method="post" onSubmit="return validarHistorialCompra(this,4,'periodo');">
											<br><br>
											<!--~~~~~~~~~~~~~~~~~~~~~~~~~~mes~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
									...
									<div style="display: none;" id="tipo">
										<form action="VerHistorialCompra_TipoVidrio.php" method="post" onSubmit="return validarHistorialCompra(this,4,'tipo');">
											<br><br>
											<!--~~~~~~~~~~~~~~~~~~~~~~~~~~tipo~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
											<span class="titulo1">Tipo Vidrio:</span>
											<select name="seleccionar_tipo" class="lista opcion" size="1" onClick="borrarMensaje(4);">
												<option selected value="">.:Opciones:.</option>
									...
									<div style="display: none;" id="proveedor">
										<form action="VerHistorialCompra_Proveedor.php" method="post" onSubmit="return validarHistorialCompra(this,4,'proveedor');">
											<br><br>
											<!--~~~~~~~~~~~~~~~~~~~~~~~~~~proveedor~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
											<span class="titulo1">Proveedor:</span>
											<select name="seleccionar_proveedor" class="lista nombre" size="1" onClick="borrarMensaje(4);">
						...
						<center>
							...
							<div id="mensaje3" class="oculto"><br><span class="alerta error">&nbsp;&nbsp;Falta seleccionar el tipo de vidrio!!&nbsp;&nbsp;</span></div>
							<div id="mensaje4" class="oculto"><br><span class="alerta error">&nbsp;&nbsp;Falta seleccionar el proveedor!!&nbsp;&nbsp;</span></div>
						</center>
						<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
