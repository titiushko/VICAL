...
$ejecutar_comando = "c:\\wamp\\bin\\mysql\\mysql5.5.24\\bin\\mysql.exe -uroot --password= vical < c:\\wamp\\www\\SCYCPVES\\backup\\$nombre";
					...
					<table align="center" class="centro resultado">
						<tr>
							<td align="center" colspan="3">
								Se cargo exitosamente el respaldo la base de datos del sistema creado el <?php echo transformasFecha(date('Y/m/d G:i:s',filemtime("c:\\wamp\\www\\SCYCPVES\\backup\\$nombre"))); ?> reemplazando el estado en el que se econtraba actualmente la base de datos del sistema.
							</td>
						</tr>
					</table>
				</td>
