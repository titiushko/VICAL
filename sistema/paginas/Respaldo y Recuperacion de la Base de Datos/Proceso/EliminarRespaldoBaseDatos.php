...
$fecha = transformasFecha(date('Y/m/d G:i:s',filemtime("c:\\wamp\\www\\SCYCPVES\\backup\\$nombre")));

unlink("c:\\wamp\\www\\SCYCPVES\\backup\\$nombre");	//elimina el archivo en la rura especificada
?>
<HTML>
	<head>
