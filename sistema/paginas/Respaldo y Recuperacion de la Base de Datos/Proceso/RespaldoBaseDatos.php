...
$ejecutar_comando = "c:\\wamp\\bin\\mysql\\mysql5.5.24\\bin\\mysqldump.exe -uroot --password= --opt vical > c:\\wamp\\www\\SCYCPVES\\backup\\$nombre";
					...
					<table align="center" class="centro resultado">
						<tr>
							<td align="center" colspan="3">
								Se guardo exitosamente el <?php echo transformasFecha(date('Y/m/d G:i:s',filemtime("c:\\wamp\\www\\SCYCPVES\\backup\\$nombre"))); ?> una copia de la base de datos del sistema en el estado que se encuentra actualmente.
							</td>
						</tr>
					</table>
				</td>
