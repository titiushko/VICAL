...
JOIN recolectores
WHERE centros_de_acopio.departamento = '$centro_de_acopio'
...
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td align="center">
					...
					<h1 class="encabezado1">CONSULTAR CENTROS DE ACOPIO POR DEPARTAMENTO</h1>
				</td>
			</tr>
<!------------------------------------------------------------------------------------------------------------------------>				
			<tr>
				<td align="center">
				<?php while($centros_de_acopio = mysql_fetch_assoc($consulta_centro_de_acopio)){ ?>
