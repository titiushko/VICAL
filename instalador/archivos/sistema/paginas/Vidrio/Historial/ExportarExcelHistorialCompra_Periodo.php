...
$consulta_factura = mysql_query($seleccionar_factura, $conexion) or die ("Fallo en consulta_factura!!".mysql_error());

$consulta_centro_de_acopio = mysql_query("SELECT nombre_centro_acopio FROM centros_de_acopio WHERE codigo_centro_acopio = '$codigo_centro_acopio'",$conexion) or die ("Fallo en la consulta_centro_de_acopio!!".mysql_error());
...
header("Content-Disposition: attachment; filename=HISTORIAL_DE_COMPRAS_DEL_".cambiarFecha(formatoFechaExtendida($fecha_inicial))."_AL_".cambiarFecha(formatoFechaExtendida($fecha_final)).".xls");
?>
<HTML>
	<head>
