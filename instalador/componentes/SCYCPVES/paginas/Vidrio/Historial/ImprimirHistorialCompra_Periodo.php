...
$nombre_documento = "HISTORIAL_DE_COMPRAS_DEL_".transformarFecha(formatoFechaExtendida($fecha_inicial))."_AL_".transformarFecha(formatoFechaExtendida($fecha_final));
?>
<HTML>
	<head>
