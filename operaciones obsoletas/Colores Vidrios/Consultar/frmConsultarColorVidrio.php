...
$instruccion_select = "SELECT codigo_color, nombre_color FROM colores_vidrio";
...
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td align="center"><!--bgcolor="#B8CEF6"-->
					...
					<h1 class="encabezado1">CONSULTAR COLORES DE VIDRIO</h1>
				</td>
			</tr>
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td>
					<table align="center" class="marco">
								...
								<table cellpadding="0" cellspacing="0" id="table" class="tinytable">
									<thead class="titulo1">
										<tr>
											...
											<th onMouseOver="toolTip('Ordenar por color DE VIDRIO',this)"><h3>Color</h3></th>
											<th class="nosort"><h3></h3></th>
										</tr>
									</thead>
									<tbody class="subtitulo2">
										<?php
										while ($colores_vidrio = mysql_fetch_array($consulta_color)){
										?>
										<tr align="center">
											<td><?php echo $colores_vidrio[0];?></td>
											<td><?php echo $colores_vidrio[1];?></td>
											<td>
												<img src="../../../imagenes/icono_modificar.png" align="top" title="Modificar" <?php echo "onClick=\"redireccionar('../Modificar/frmModificarColorVidrio.php?modificar_color=$colores_vidrio[0]');\"";?> class="manita">
												<img src="../../../imagenes/icono_eliminar.png" align="top" title="Eliminar" <?php echo "onClick=\"redireccionar('../Eliminar/frmEliminarColorVidrio.php?eliminar_color=$colores_vidrio[0]');\"";?> class="manita">
											</td>
										</tr>
										<?php
										}
						...
						<tr>
							...
							<td>
								<img src="../../../imagenes/icono_agregar.png" align="top" onClick="redireccionar('../Nuevo/frmNuevoColorVidrio.php')" onMouseOver="toolTip('Agregar un nuevo color DE VIDRIO',this)" class="manita">
